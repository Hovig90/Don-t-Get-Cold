...
extension UIColor {
    ...
    convenience init(hex: AppConstants.Colors, alpha: Double = 1) {
        self.init(red:(hex.rawValue >> 16) & 0xff, green:(hex.rawValue >> 8) & 0xff, blue:hex.rawValue & 0xff, alpha: alpha)
    }
